...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://ClaudiaKalnitskaya.github.io/react_list-of-goods/) and add it to the PR description.
