...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://oksanatytanych.github.io/react_list-of-goods-js/) and add it to the PR description.
