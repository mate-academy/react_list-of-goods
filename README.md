...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Zykhor-Andriinpm run .github.io/react_list-of-goods/) and add it to the PR description.
