# React list of goods
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://troospieler.github.io/react_list-of-goods/)
...
1. Add ` show the goods in reversed order
1. Add `Sort alphabetically` bReverse` button toutton to show the goods in alphabetical order
