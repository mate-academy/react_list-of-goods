# React list of goods
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://vlad-trundenko.github.io/react_list-of-goods/)
...
1. Add `
` button to show the goods in alphabetical order
